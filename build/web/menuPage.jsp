<%-- 
    Document   : menuPage
    Created on : Nov 18, 2018, 10:30:49 AM
    Author     : haihq
--%>
...
<meta property="og:updated_time" content="2017-01-04T04:27:17.7305865+00:00">
...
<link rel="canonical" href="http://us-123sushi.simplesite.com/410908035">
        ...
        <script type="text/javascript" async="" src="./Menu_files/analytics.js.download"></script><script async="" src="./Menu_files/gtm.js.download"></script><script type="text/javascript" src="./Menu_files/FrontendAppLocalePage.aspx"></script>
                <script type="text/javascript" src="./Menu_files/frontendApp.min.js.download"></script>
...
<haihq:forEach var="menus" varStatus="No" items='${sessionScope.PRODUCT_FOLLOW_MENU}'>
<div class="content">
    <div class="section">
        <div class="content">
            <table class="table">
                <thead>
                    <tr>
                        <th>${menus.menuName}</th>
                                                <th class="align-right">Price</th>
                    </tr>
                </thead>
                <tbody>
                    <haihq:forEach var="products" varStatus="No" items='${menus.listProduct}'>
                    <tr>
                        <td>${products.productName}</td>
                                                <td class="align-right">${products.productPrice}</td>
                    </tr>
                    </haihq:forEach>
...
<div class="heading wordwrapfix">
    ...
    <div class="container">
        <div class="footer-info">
                    ...
                    <a rel="nofollow" href="http://www.simplesite.com/pages/receive.aspx?partnerkey=123i%3afooterbanner&amp;referercustomerid=10674955&amp;refererpageid=410908035">Created with SimpleSite</a>
                </div>
        </div>
...
<script type="text/javascript" src="./Menu_files/conversion.js.download"></script><iframe name="google_conversion_frame" title="Google conversion frame" width="300" height="13" src="./Menu_files/saved_resource.html" frameborder="0" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" scrolling="no"></iframe>
<noscript></noscript>
</div></body></html>
