<%-- 
    Document   : homePage
    Created on : Nov 18, 2018, 10:26:19 AM
    Author     : haihq
--%>
...
<li class=" active " style="">
    ...
    <a rel="nofollow" href="MainServlet?btAction=showProductByMenuID">Menu and Price list</a>
</li><li class="  " style="">
    <a rel="nofollow" href="MainServlet?btAction=showInfo">Find us</a>
</li><li class="  " style="">
    <a rel="nofollow" href="MainServlet?btAction=showInfo">Find us new</a>
</li>
...
<haihq:forEach var="product" varStatus="No" items='${sessionScope.PRODUCTS}'>
    <div class="section article">
    <style>    .wordwrapfix {
...
<div class="img-simple span6 pull-left">
    <div class="image">
            <a rel="nofollow" data-ss="imagemodal" data-href="http://cdn.simplesite.com/i/eb/15/282319406464701931/i282319414620340695._szw1280h1280_.jpg"><img src=${product.productPicture}></a>
    </div>
    </div>
<p><span>${product.description}</span></p>    </div>
</div>
</haihq:forEach>
